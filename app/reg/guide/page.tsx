...
const steps = [
  ...
  {
    title: "正式提交报名信息",
    text: "确认所有信息无误且照片上传成功后，点击“正式提交”。提交成功后系统会跳转到报名信息页，状态显示为“已提交”。",
    labels: ["正式提交", "报名信息已提交", "报名状态：已提交"]
  },
  {
    title: "查询、修改或找回查询密码",
    ...
    <main className="container guide-page">
      ...
      <section className="guide-tips">
        ...
        <ul>
          ...
          <li>草稿不会进入导出材料，只有“已提交”的报名信息才算正式报名。</li>
          <li>照片不符合尺寸、格式或大小要求时，系统会阻止正式提交。</li>
          <li>提交后如需修改，在报名入口开放期间可通过查询报名信息进入修改。</li>
        </ul>
      </section>
    </main>
  );
